...
_VAR_DEFAULTS = {
    ...
    'JUTURNA_ENV_VAR_PREFIX': '$JT_ENV_',
    'JUTURNA_TELEMETRY_BATCH_SIZE': 10,
    'JUTURNA_EXTERNAL_PLUGIN_MIN_VER': 3.0,
    'JUTURNA_INTERNAL_PLUGIN_MAX_VER': 2.0,
}
...
JUTURNA_EXTERNAL_PLUGIN_MIN_VER = get_constant_var(
    'JUTURNA_EXTERNAL_PLUGIN_MIN_VER'
)
JUTURNA_INTERNAL_PLUGIN_MAX_VER = get_constant_var(
