...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PROTOENVELOPE']._serialized_end = 1335
    _globals['_COMPRESSEDPROTOPAYLOAD']._serialized_start = 1338
    _globals['_COMPRESSEDPROTOPAYLOAD']._serialized_end = 1479
